const strings = {
  ...
  HackSessionTimeline: {
    ...
    days: [
      ...
      { num: "1", date: "1/28", hook: "Git & HTML" },
      { num: "2", date: "2/4", hook: "React" },
      { num: "3", date: "2/11", hook: "APIs & Databases" },
      { num: "4", date: "2/25", hook: "CSS" },
      { num: "5", date: "3/3", hook: "Troubleshooting" },
      { num: "6", date: "3/17", hook: "Co-op Panel" },
      { num: "7", date: "3/24", hook: "Work week" },
      { num: "8", date: "3/31", hook: "Presenting" },
