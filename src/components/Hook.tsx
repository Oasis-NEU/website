...
export default function Hook({scrollJump}: Props) {
  return (
    <div className="bg-no-repeat overflow-hidden bg-cover landingPageImage min-h-[360px] h-[90vh] relative">
      ...
      <div className="min-h-[360px] h-[90vh] flex flex-col justify-center items-center z-10">
